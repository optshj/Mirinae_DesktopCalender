...
import { useInputForwarding } from '@/shared/lib/useInputForwarding'
...
export function Calendar() {
    ...
    const { enableInputForwarding, disableInputForwarding } = useInputForwarding()
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div 
                className={`w-full transition-all duration-300 ease-in-out ${isFlipCalendar ? 'pointer-events-none mt-[-16px] scale-95 opacity-0' : 'mt-0 scale-100 opacity-100'} `}
