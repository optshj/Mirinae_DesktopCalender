...
export default function ScheduleModal({ date, items, onClose, onSuccess }: ScheduleModalProps) {
        ...
        <Modal onClose={onClose}>
            ...
            {showForm ? (
                <form
                    ...
                    className="border-main-color animate-fade-in mt-2 flex flex-col gap-3 rounded-xl border bg-white p-4"
                >
                    <div className="flex flex-col gap-1">
                        ...
                        <HangulInput
                            id="summary"
                            className="focus:ring-main-color rounded-lg border border-zinc-300 py-2 pr-20 pl-3 focus:ring-2 focus:outline-none"
                            type="text"
                            value={summary}
                    ...
                    <div className="mt-2 flex gap-2">
                        <button type="submit" className="bg-main-color flex-1 rounded-lg px-3 py-2 font-semibold text-white shadow">
                            추가
                        </button>
                        <button
                            type="button"
